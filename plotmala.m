...
plot([bkProt; bkDeprot],[symMalaRoux(:,1); symMalaRoux(:,2)],'g*','linewidth',2,'markersize',12);
...
legend('MD, this work','NLBC', 'Poisson (Nina radii, BEM)',...
       'Poisson (Nina radii, FDM)', 'MD, Nina et al.','location','southwest');
