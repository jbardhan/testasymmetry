...
fid = fopen('mnsol/nitrobenzene_ions.csv','r'); 
...
testset  = {'acetic_acid','methanol','p_cresol','nitrobenzene','nitromethane','phenol','Li','Na','K','Rb','Cs','Cl','Br','I'};
...
save('OptNitrobenzene','x','ref','calc','es','np','x0','calc0','es0','np0');
