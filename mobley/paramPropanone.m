...
epsIn  =  1;
Tbase = 300; 
epsOut = 20.83; % from Lomize et. al Anistoropic solvent model of the lipid bilayer
...
lb = [-2 -200 -100 -1  -20  -0.1  -4];
ub = [+2 +200 +100 +1  +20  +0.1  +4];
...
save('OptPropanone','x','ref','calc','es','np','x0','calc0','es0','np0');
