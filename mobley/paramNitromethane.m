...
fid = fopen('mnsol/nitromethane_ions.csv','r'); 
...
testset  = {'butanone','14_dioxane','n_octane','ethanol','nitromethane','toluene','Li','Na','K','Cl','Br','I'};
...
save('OptNitromethane','x','ref','calc','es','np','x0','calc0','es0','np0');
