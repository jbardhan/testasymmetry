...
NaReference = -392.4; NaR = 0.92*1.41075; NaSurfArea = 4*pi*NaR^2;
KReference  = -336.6; KR = 0.92*1.76375; KSurfArea = 4*pi*KR^2;
ClReference = -266.3; ClR = 0.92*2.27; ClSurfArea = 4*pi*ClR^2;
