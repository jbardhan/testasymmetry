...
logfileName = 'dibutylether.out';
epsOut = 3.0473; % from MNSol

ParamOctInfo = load('OptDibutylether');
x = ParamOctInfo.x;
fid = fopen('mnsol/dibutylether.csv','r'); 
...
save('RunDibutylether','errfinal','calcE','refE','es','np');
