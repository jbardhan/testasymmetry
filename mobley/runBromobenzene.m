...
logfileName = 'bromobenzene.out';
epsOut = 5.3954; % from MNSol

ParamOctInfo = load('OptBromobenzene');
x = ParamOctInfo.x;
fid = fopen('mnsol/bromobenzene.csv','r'); 
...
save('RunBromobenzene','errfinal','calcE','refE','es','np');
