function [calculatedE, referenceE,nonpolar,...
          disp,disp_sl_sl,disp_sv_sl,disp_sv_sv,cav,comb] = CalculateEnergiesFromBEMCosmoNp(Params)
...
for i=1:numProblems
  ...
  [newCalculatedE, newReferenceE,newNonpolar,newDisp,...
   newDisp_sl_sl,newDisp_sv_sl,newDisp_sv_sv,newCav,newComb] = ...
   calculateProblemCosmoNp(curProblem, Params);
