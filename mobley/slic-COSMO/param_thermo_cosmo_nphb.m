...
for j=1:tempdiv
    ...
    thermo_data = readtable('ref_np.csv'); 
    ...
    dS_ref = -thermo_data.Var3/(t_ref_aca + KelvinOffset);
    Cp_ref =  thermo_data.Var4/1000;
...
save('OptWater_Cosmo_thermo_nphb.mat','xvec','refvec','calcvec','esvec','npvec','dispvec','cavvec','combvec','hbvec',...
    'xvec0','refvec0','calcvec0','npvec0','dispvec0','cavvec0','combvec0','hbvec0',...
    'x0vec','calc0vec','np0vec','testset','dS','Cp','tempvec','ionflag','aca_num','ion_num','t_ref_aca','t_ref_ion','rmse');
