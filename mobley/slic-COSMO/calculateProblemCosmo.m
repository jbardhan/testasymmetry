function [calculatedE, referenceE, electrostatic, nonpolar,...
          dG_hb, dG_disp, dG_disp_sl, dG_disp_sv, dG_comb] = calculateProblemCosmo(problem,params)
...
for i=1:numTestsInProblem
  [calculatedE(i),electrostatic(i),nonpolar(i),...
   dG_hb(i),dG_disp(i),dG_disp_sl(i),dG_disp_sv(i),dG_comb(i)] = ...
