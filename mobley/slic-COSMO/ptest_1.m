...
x0  =  [0.453   -48.813	-0.541	-0.548	-0.062	... %slic
        1.216	1.138	1.140	1.438	0.842	0.164 ... %disp
        0.000	1.090	0.860	0.641	1.095	0.160 ... %disp
        0.327	0.886	0.442	0.828	1.153	0.358 ... %disp
...
save('OptCosmonew_DISP_HB.mat','x','training_set','mol_list','ref','calc','es','np','hb','disp',...
