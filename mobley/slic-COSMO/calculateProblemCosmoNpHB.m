function [calculatedE, referenceE, nonpolar,dG_HB,...
          dG_disp, dG_disp_sl_sl, dG_disp_sv_sl,...
          dG_disp_sv_sv,dG_cav,dG_comb] = calculateProblemCosmoNpHB(problem,params)
...
for i=1:numTestsInProblem
  [calculatedE(i),nonpolar(i),dG_HB,dG_disp(i),...
   dG_disp_sl_sl(i),dG_disp_sv_sl(i),dG_disp_sv_sv(i),dG_cav(i),dG_comb(i)] = ...
   runTestCosmoNpHB(params, problem, problem.chargeDistribution(:,i));
end
