...
fid = fopen('mnsol/dimethylacetamide_ions.csv','r'); 
...
testset  = {'butanone','n_octane','ethanol','toluene','14_dioxane','nitromethane','Li','Na','K','Cl','Br','I'};
...
save('OptDimethlyacetamide','x','ref','calc','es','np','x0','calc0','es0','np0');
