...
[mol_list,dG_list,surfArea_list]=textread('mnsol/tetrahydrofuran.csv',...
					  '%s %f %f','delimiter',',');


testset  = {'toluene','ethanol','butanone','nitromethane','n_octane','14_dioxane','tetrahydrofuran'};
