...
epsIn  =  1;
Tbase = 300; 
epsOut = 11.4; % from Wakai,Ott,Weingartner 2005 (JPCB Lett, v 109:17028)
...
fid = fopen('reference-data/mobley_latif_bmim_pf6.csv','r'); 
...
save('OptLatifBMIM_PF6','x','ref','calc','es','np','x0','calc0','es0','np0');
