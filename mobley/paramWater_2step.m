...
for kk=1:tempdiv
    ...
    if ionflag==1
        ...
        dG_es = Data{7};% electrostatic energies
    ...
    npMinimizer  = @(x_np)(x_np(1).*surfArea_list(1:12) + x_np(2))-(dG_list_aca-dG_es_list(1:12));
    ...
    ParamWatInfo=load('OptWater_thermo_Picard_20_new_initial_guess.mat');
    x_p20 = ParamWatInfo.xvec(kk,:);
    x0 = [x_p20(1) x_p20(2) x_p20(3) x_p20(4) x_p20(5) x_np(1) x_np(2)];
...
elseif ionflag==1
    save('OptWater_thermo_2step_p20','xvec','refvec','calcvec','esvec','npvec','x0vec','calc0vec','es0vec','np0vec','testset','dS_list','CP_list','tempvec','ionflag','aca_num','ion_num','t_ref_aca','t_ref_ion');
end