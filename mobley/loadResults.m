...
for i = 1:length(solvents)
    ...
    if ploton
        ...
        Leg_w_rms = {strcat('Unclassified: ',num2str(err_pred,'%.2f')),strcat('Training Set: ',num2str(err_testset,'%.2f')),strcat('Esters: ',num2str(err_est,'%.2f')),...
               ...
               strcat('Nitro compounds: ',num2str(err_nit,'%.2f')),strcat('Nitriles: ',num2str(err_ntr,'%.2f')),strcat('Acids: ',num2str(err_acd,'%.2f')),...
               strcat('Ketones: ',num2str(err_ktn,'%.2f')),strcat('Haloalkanes: ',num2str(err_hlk,'%.2f')),strcat('Haloalkenes: ',num2str(err_hle,'%.2f')),...
               strcat('Halo phenols: ',num2str(err_hlf,'%.2f')),strcat('Phenol derivatives: ',num2str(err_phn,'%.2f')),strcat('Halobenzenes: ',num2str(err_hbz,'%.2f')),...
