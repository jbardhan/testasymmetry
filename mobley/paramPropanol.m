...
fid = fopen('mnsol/propanol_ions.csv','r'); 
...
testset  = {'anthracene','butanone','cyclohexane','ethanol',...
    'nitromethane','benzene','butan_1_ol','methanol',...
    'phenanthrene','4_nitroaniline','propan_1_ol','toluene',...
    'Na','K','Li','Cl','Br','I'};
...
save('OptPropanol','x','ref','calc','es','np','x0','calc0','es0','np0');
