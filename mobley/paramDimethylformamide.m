...
[mol_list,dG_list,surfArea_list]=textread('mnsol/dimethylformamide.csv',...
					  '%s %f %f','delimiter',',');
...
NaReference = -0.239*434; NaR = 0.92*1.41075; NaSurfArea = 4*pi*NaR^2;
KReference  = -0.239*362; KR = 0.92*1.76375; KSurfArea = 4*pi*KR^2;
ClReference = -0.239*256; ClR = 0.92*2.27; ClSurfArea = 4*pi*ClR^2;
