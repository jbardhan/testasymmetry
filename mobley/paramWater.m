...
for mm=1:1
    ...
    for kk=1:tempdiv
        ...
        if ionflag==1
            testset_total  = {'methane', 'ethanamide', 'methanethiol', 'n_butane', '2_methylpropane', 'methyl_ethyl_sulfide', 'toluene', 'methanol', 'ethanol', '3_methyl_1h_indole', 'p_cresol', 'propane','Li','Na','K','Rb','Cs','Cl','Br','I'};  % test set without florine
        end
        ...
        dG_list_total(:,kk)=[dG_list_aca;dG_list_ion];
        dS_list_total(:,kk)=[dS_list_ref_at_298;dS_list_ref_ion_at_298_15];
        CP_list_total(:,kk)=[CP_list_ref_at_298;CP_list_ref_ion_at_298_15];
