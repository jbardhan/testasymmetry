...
testset  = {'acetic_acid','methanol','p_cresol','butan_1_ol','methyl_acetate','phenol','Li','Na','K','Rb','Cs','Cl','Br','I'};
...
save('OptDichloroethane','x','ref','calc','es','np','x0','calc0','es0','np0');
