...
def meshGen2D1S (d0,spacing,df):
    ...
    for distance in distRange:
        ...
        mol12Diel = "mol12_diel_%3.1f.xyzr" % (distance)
        mol12Stern = "mol12_stern_%3.1f.xyzr" % (distance)
        ...
        mol12_D_msms = "%s%s%s%s" % (msmsPath,' -if ',mol12Diel,' -de 2.0 -prob 1.4 -of mol12_diel')
        mol1_S_msms = "%s%s%s%s" % (msmsPath,' -if ',mol1Stern,' -de 8.0 -prob 1.4 -of mol1_stern')
        mol2_S_msms = "%s%s%s%s" % (msmsPath,' -if ',mol2Stern,' -de 8.0 -prob 1.4 -of mol2_stern')
        mol12_S_msms = "%s%s%s%s" % (msmsPath,' -if ',mol12Stern,' -de 2.0 -prob 1.4 -of mol12_stern')
        os.system(mol1_D_msms)
        os.system(mol2_D_msms)
        os.system(mol12_D_msms)
        os.system(mol1_S_msms)
        os.system(mol2_S_msms)
        os.system(mol12_S_msms)
        ...
        Path('%s/%s' % (dirPath,'mol12_diel')).touch()
        Path('%s/%s' % (dirPath,'mol12_Stern')).touch()
