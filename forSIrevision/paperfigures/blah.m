...
%Enl_prot_l12_solv = squeeze(Enlprot(:,2,:))-Erefprot;
Enl_prot_l15_solv = squeeze(Enlprot(:,1,:))-Erefprot;

%Enl_deprot_l10_solv = squeeze(Enldeprot(:,1,:))-Erefdeprot;
%Enl_deprot_l12_solv = squeeze(Enldeprot(:,2,:))-Erefdeprot;
...
%Enl_l12_res_prot_solv = estimateDetails.prot_nl(2,:)-estimateDetails.prot_ref(2,:);
...
%Enl_l12_res_deprot_solv = estimateDetails.deprot_nl(2,:)-estimateDetails.deprot_ref(2,:);
