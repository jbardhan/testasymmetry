...
h       = 1.0;
hFine   = h; % for now
[pqrReacGrid,Ygrid,Zgrid]  = addPqrGridSpherePlane(R-h, struct('q',[],'xyz',[],'R',[]),h); 
...
bemSourceChargeLine = makeBemEcfQualMatrices(surfdata, pqrSourceChargeLine,  epsIn, epsOut);
...
L_asym = conv_factor * L_asym;
L_sym  = conv_factor * L_sym;