function [calculatedE, referenceE, electrostatic, nonpolar] = calculateProblemSA(problem,params)
...
for i=1:numTestsInProblem
  [calculatedE(i),electrostatic(i),nonpolar(i)] = runTestSA(params, problem, problem.chargeDistribution(:,i));
end
