function [Error,calculatedE,referenceE,electrostatic,nonpolar] = ObjectiveFromBEMSA3(x)
...
[calculatedE,referenceE,electrostatic,nonpolar] = CalculateEnergiesFromBEMSA3(Params); 
