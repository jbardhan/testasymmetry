function Error_MSA = ObjectiveFunction_MSA_ref(x)
...
F = Level_2_MSA_ref(Params); % Calls the function Level_2_MSA.m which calculates the energy using bornPicardNoStern.
